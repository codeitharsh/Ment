...
# Load courses_list and similarity
    ...
    a={'course_name':["Not Working","Try later"],}
    courses_2 = pd.DataFrame(a) 
...
def index(request):
    courses = {'courses_list': courses_2['course_name'].values()}  # Assuming 'course_name' is the column name in courses_list

    if request.method == 'GET':
        return render(request, 'course_recommendation/course_rec.html', context=courses)
        ...
        return render(request, 'course_recommendation/course_rec.html', context)